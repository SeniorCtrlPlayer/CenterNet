cd src
# train
python main.py multi_pose --exp_id dla_3x --dataset coco_hp --batch_size 32 --master_batch 9 --lr 5e-4 --load_model ../models/ctdet_coco_dla_2x.pth --gpus 0,1,2,3,4,5,6,7 --num_workers 4 --num_epochs 320 lr_step 270,300
