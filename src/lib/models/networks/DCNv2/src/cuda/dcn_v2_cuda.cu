                    ...
                    const int deformable_group)
{
    ...
    int height_out_temp = 0;
    int width_out_temp = 0;
    if (height % stride_h == 0)
    {
        height_out_temp = height / stride_h;
    }else
    {
        height_out_temp = height / stride_h + 1;
    }
    if (width % stride_w == 0)
    {
        width_out_temp = width / stride_w;
    }else
    {
        width_out_temp = width / stride_w + 1;
    }
    const int height_out = height_out_temp;
    const int width_out = width_out_temp;
